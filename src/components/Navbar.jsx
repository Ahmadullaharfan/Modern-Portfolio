    ...
    return (
        <nav className="fixed w-full bg-darker/80 backdrop-blur-sm z-50 shadow-lg">
            <div className="container mx-auto px-6 py-4">
                ...
                <div className={`md:hidden mt-4 pb-2 ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <a href="#home" className="block py-2 nav-link active">Home</a>
                    <a href="#about" className="block py-2 nav-link">About</a>
                    <a href="#skills" className="block py-2 nav-link">Skills</a>
